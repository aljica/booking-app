...
// Work with time slots/bookings
const booking = require('./controllers/booking.controller.js');

app.use('/api', booking.router);
// Demo calls for assistants & times
model.addAssistant('john');
model.addAssistant('sara');
model.addTimeSlot('john', '00:00');
model.addTimeSlot('john', '04:00');
model.addTimeSlot('sara', '03:00');
